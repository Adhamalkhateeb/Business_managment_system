...
namespace BMS.DAL.Interface
{
    ...
    public interface IDepartmentRepository
    {
        ...
        Task<int> AddAsync(string departmentName, string Description, int CreatedBy);
        ...
        Task<bool> UpdateAsync(int departmentID, string Description, string departmentName, int? modifiedByUserID);
        ...
        Task<List<T>> GetAllAsync<T>(int? PageNumber, int? Records, string? FilterColumn, string? FilterValue) where T : new();
        ...
        Task<bool> DeleteAsync(int departmentID, int? UserID);
