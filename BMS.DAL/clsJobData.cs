...
namespace DAL
{
    ...
    public class clsJobData
    {
        ...
        {
            return await clsGlobalDatabase.ExecuteNonQueryAsync("SP_AddNewJob", new SqlParameter[]
        ...
        {
            return await clsGlobalDatabase.ExecuteNonQueryAsync("SP_UpdateJob", new SqlParameter[]
        ...
        public static async Task<DataTable> GetAlljobsAsync(int? PageNumber, int? Records,string? FilterColumn,string? FilterValue) =>
            await clsGlobalDatabase.GetAllAsyncByStoredProcedure("SP_GetAll_Jobs", new SqlParameter[]
            {
        ...
        {
            if (await clsGlobalDatabase.ExecuteNonQueryAsync("CheckjobDependencies", new SqlParameter[] { new SqlParameter("@JobID", JobID) }) != 1)
                return await clsGlobalDatabase.ExecuteNonQueryAsync("SP_DeleteJob", new SqlParameter[]
                {
                 new SqlParameter("@JobID", JobID),
        ...
        public static async Task<Dictionary<string, object>> GetJobByIDAsync(int JobID) =>
             await clsGlobalDatabase.GetSingleRecord("SP_Get_job", new SqlParameter[]
             {
                 new SqlParameter("@JobID",JobID)
             });
        ...
        public static async Task<Dictionary<string, object>> GetJobByNameAsync(string JobTitle) =>
              await clsGlobalDatabase.GetSingleRecord("sp_Get_Job_ByName", new SqlParameter[]
              {
                 new SqlParameter("@JobTitle",JobTitle)
              });
